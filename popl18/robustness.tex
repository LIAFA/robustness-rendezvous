...
\begin{lemma}\label{lem:synch_canonical1}
...
The second and the third item in Definition~\ref{def:conf_graph} represent conflicts occurring in canonical completions of the trace $t$.
