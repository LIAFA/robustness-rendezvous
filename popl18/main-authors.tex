\documentclass[acmsmall,review]{acmart}\settopmatter{printfolios=true} %anonymous
...
\affiliation{
  ...
  \institution{University Paris Diderot}            %% \institution is required
...
\affiliation{
  ...
  \streetaddress{14820 NE 36th Street, Building 99}
  \city{Redmond	}
  \state{Washington}
  \postcode{98052}
  \country{United States}
}
\email{qadeer@microsoft.com}          %% \email is recommended
