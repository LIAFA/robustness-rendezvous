...
All the examples are synchronizable, which confirms our conviction that non-synchronizability should correspond to an ill-designed system (and therefore it should be reported as an anomaly). %Therefore, our approach always terminates and is complete for these systems.
